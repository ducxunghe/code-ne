...
!(function (t, e) {
	...
	const H = {
			...
			trigger(t, e, i) {
				...
				return (
					o &&
						s &&
						((a = s.Event(e, i)), s(t).trigger(a), (l = !a.isPropagationStopped()), (c = !a.isImmediatePropagationStopped()), (h = a.isDefaultPrevented())),
	...
	class pt extends R {
		...
		static dataApiKeydownHandler(t) {
			...
			if ('Escape' !== t.key)
				return 'ArrowUp' === t.key || 'ArrowDown' === t.key ? (e || s.show(), void s._selectMenuItem(t)) : void ((e && 'Space' !== t.key) || pt.clearMenus());
			s.hide();
		}
	}
